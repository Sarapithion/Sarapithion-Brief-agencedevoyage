...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdvReservationController' => 'getAdvReservationControllerService',
            'App\\Controller\\AdvUserController' => 'getAdvUserControllerService',
            'App\\Controller\\AdvVoyageController' => 'getAdvVoyageControllerService',
            'App\\Controller\\Api\\ReservationController' => 'getReservationControllerService',
            'App\\Controller\\Api\\UserController' => 'getUserControllerService',
            'App\\Controller\\Api\\VoyageController' => 'getVoyageControllerService',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Yj8xvvC6Je', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AdvCategorieRepository' => ['privates', 'App\\Repository\\AdvCategorieRepository', 'getAdvCategorieRepositoryService', true],
            'App\\Repository\\AdvPaysRepository' => ['privates', 'App\\Repository\\AdvPaysRepository', 'getAdvPaysRepositoryService', true],
            'App\\Repository\\AdvReservationRepository' => ['privates', 'App\\Repository\\AdvReservationRepository', 'getAdvReservationRepositoryService', true],
            'App\\Repository\\AdvRoleRepository' => ['privates', 'App\\Repository\\AdvRoleRepository', 'getAdvRoleRepositoryService', true],
            'App\\Repository\\AdvStatutRepository' => ['privates', 'App\\Repository\\AdvStatutRepository', 'getAdvStatutRepositoryService', true],
            'App\\Repository\\AdvUserRepository' => ['privates', 'App\\Repository\\AdvUserRepository', 'getAdvUserRepositoryService', true],
            'App\\Repository\\AdvVoyageRepository' => ['privates', 'App\\Repository\\AdvVoyageRepository', 'getAdvVoyageRepositoryService', true],
        ], [
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdvReservationController', 'App\\Controller\\AdvUserController', 'App\\Controller\\AdvVoyageController', 'App\\Controller\\Api\\ReservationController', 'App\\Controller\\Api\\UserController', 'App\\Controller\\Api\\VoyageController', 'App\\Controller\\HomeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('UTzVSTjNbQ', 0, $container->getParameter('container.build_id'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mjfHbT29S9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BYX7ueK2bI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LJCo7K-4HJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pUxibOx2Gt', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ltoFzBUvdu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
