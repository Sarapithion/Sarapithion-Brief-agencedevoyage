...
{
    #[Route(path:'/', name: 'app_adv_voyage_index', methods: ['GET'])]
    ...
    #[Route('/adv/voyage/new', name: 'app_adv_voyage_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/adv/voyage/{id}', name: 'app_adv_voyage_show', methods: ['GET'])]
    ...
    #[Route('/adv/voyage/{id}/edit', name: 'app_adv_voyage_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/adv/voyage/{id}', name: 'app_adv_voyage_delete', methods: ['POST'])]
